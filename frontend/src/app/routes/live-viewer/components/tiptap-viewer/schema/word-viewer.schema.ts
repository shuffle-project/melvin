...
import { TiptapViewerService } from '../tiptap-viewer.service';

export const CustomWordViewer = (injector: Injector) => {
  return Mark.create({
    name: 'word',
    exitable: true,
    spanning: false,
    ...
    renderHTML({ HTMLAttributes }) {
      ...
      if (modifiedBy) {
        const tiptapEditorService = injector.get(TiptapViewerService);
